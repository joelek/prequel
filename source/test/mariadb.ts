...
const DETAIL: prequel.stores.DatabaseObjectStoreDetail = {
	getConnection: getConnection,
	generateId: () => prequel.ids.generateHexId(32)
};

export const OBJECTS = new prequel.stores.DatabaseObjectStore(DETAIL, "objects", "object_id", objects.Object, {});
